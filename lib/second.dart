          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: Color(0xff2b2b2b),),
                child: Column(
                  children: [
                    Row(
                    ...
                    Slider(value:widget.bmi,thumbColor: Color(0xffdafd87),activeColor: Color(0xff395220),min: 1,max: 220, onChanged: (value){
                      setState(() {
                        widget.bmi;
                      });
                    }),
              ...
              Container(
                ...
                },backgroundColor:Color(0xffdafd87) ,child:
                  Row(
